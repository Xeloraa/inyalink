      ...
      {tile.srcs.map((src, layer) => {
        ...
        return (
          <img
            ...
            decoding="async"
            draggable={false}
            className={`absolute inset-0 h-full w-full object-cover brightness-[0.72] contrast-[1.06] saturate-[0.92] ${
 ...
 * Decorative — paused on hover, tinted so the white input stays brightest.
 */
export function HeroGrid() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 bg-[rgba(4,36,26,0.42)]" />
    </div>
  );
}
