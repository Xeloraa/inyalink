...
insert into profiles (id, role, display_name, locale, is_admin) values
  -- professionals (fictional names only)
  ('a0000000-0000-4000-8000-000000000001', 'professional', 'မင်းထက် · Min Thet', 'my', false),
  ('a0000000-0000-4000-8000-000000000002', 'professional', 'သူဇာ · Su Zar', 'my', false),
  ('a0000000-0000-4000-8000-000000000003', 'professional', 'နေလင်း · Nay Lin', 'my', false),
  ('a0000000-0000-4000-8000-000000000004', 'professional', 'ခိုင်ဇော် · Khine Zaw', 'my', false),
  ('a0000000-0000-4000-8000-000000000005', 'professional', 'ဖြူဖြူ · Phyu Phyu', 'my', false),
  ('a0000000-0000-4000-8000-000000000006', 'professional', 'အောင်ကို · Aung Ko', 'my', false),
  ('a0000000-0000-4000-8000-000000000007', 'professional', 'သီရိ · Thiri', 'my', false),
  ('a0000000-0000-4000-8000-000000000008', 'professional', 'မျိုးမင်း · Myo Min', 'my', false),
  ('a0000000-0000-4000-8000-000000000009', 'professional', 'ဝင်းထွဋ် · Win Htut', 'my', false),
  ('a0000000-0000-4000-8000-00000000000a', 'professional', 'စုစု · Su Su', 'my', false),
  ('a0000000-0000-4000-8000-00000000000b', 'professional', 'ကျော်ဇေယျ · Kyaw Zeya', 'my', false),
  ('a0000000-0000-4000-8000-00000000000c', 'professional', 'မေသူ · May Thu', 'my', false),
  ('a0000000-0000-4000-8000-00000000000d', 'professional', 'ထွန်းလင်း · Tun Lin', 'my', false),
  ('a0000000-0000-4000-8000-00000000000e', 'professional', 'နှင်းဥမ္မာ · Hnin Ohmar', 'my', false),
  ('a0000000-0000-4000-8000-00000000000f', 'professional', 'စိုင်းမောင် · Sai Maung', 'my', false),
  ('a0000000-0000-4000-8000-000000000010', 'professional', 'မြတ်နိုး · Myat Noe', 'my', false),
  ('a0000000-0000-4000-8000-000000000011', 'professional', 'ဇော်မင်း · Zaw Min', 'my', false),
  ('a0000000-0000-4000-8000-000000000012', 'professional', 'နန္ဒာ · Nanda', 'my', false),
  ('a0000000-0000-4000-8000-000000000013', 'professional', 'ကိုကို · Ko Ko', 'my', false),
  ('a0000000-0000-4000-8000-000000000014', 'professional', 'သဇင် · Thazin', 'my', false),
  ('a0000000-0000-4000-8000-000000000015', 'professional', 'ရန်နိုင် · Yan Naing', 'my', false),
  ('a0000000-0000-4000-8000-000000000016', 'professional', 'ခင်မျိုး · Khin Myo', 'my', false),
  ('a0000000-0000-4000-8000-000000000017', 'professional', 'အေးချမ်း · Aye Chan', 'my', false),
  ('a0000000-0000-4000-8000-000000000018', 'professional', 'မင်းခေါင် · Min Khant', 'my', false),
  ('a0000000-0000-4000-8000-000000000019', 'professional', 'စုမြတ် · Su Myat', 'my', false),
  ('a0000000-0000-4000-8000-00000000001a', 'professional', 'နေမာန် · Nay Marn', 'my', false),
  ('a0000000-0000-4000-8000-00000000001b', 'professional', 'ဖြူဇာ · Phyu Zar', 'my', false),
  ('a0000000-0000-4000-8000-00000000001c', 'professional', 'ဟိန်းထက် · Hein Thet', 'my', false),
  ('a0000000-0000-4000-8000-00000000001d', 'professional', 'ရွှေရည် · Shwe Yee', 'my', false),
  -- clients
  ('b0000000-0000-4000-8000-000000000001', 'client', 'Demo Client 01', 'my', false),
  ('b0000000-0000-4000-8000-000000000002', 'client', 'Demo Client 02', 'my', false),
  ('b0000000-0000-4000-8000-000000000003', 'client', 'Demo Client 03', 'en', false),
  ('b0000000-0000-4000-8000-000000000004', 'client', 'Demo Client 04', 'my', false),
  ('b0000000-0000-4000-8000-000000000005', 'client', 'Demo Client 05', 'my', false),
  ('b0000000-0000-4000-8000-000000000006', 'client', 'Demo Client 06', 'en', false),
  ('b0000000-0000-4000-8000-000000000007', 'client', 'Demo Client 07', 'my', false),
  ('b0000000-0000-4000-8000-000000000008', 'client', 'Demo Client 08', 'my', false),
  ('b0000000-0000-4000-8000-000000000009', 'client', 'Demo Client 09', 'en', false),
  ('b0000000-0000-4000-8000-00000000000a', 'client', 'Demo Client 10', 'my', false),
  ('b0000000-0000-4000-8000-00000000000b', 'client', 'Demo Client 11', 'my', false),
  ('b0000000-0000-4000-8000-00000000000c', 'client', 'Demo Client 12', 'en', false),
  -- local admin
  ('c0000000-0000-4000-8000-000000000001', 'admin', 'Demo Admin', 'en', true)
on conflict (id) do nothing;
